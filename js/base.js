...
function Base(_this){
	...
	this.elements=[];
	if(_this!=undefined){//_this是一个对象，undefined也是一个对象，区别与typeof返回的代单引号的'undefined'
...
//设置鼠标移入移出方法
Base.prototype.hove=function(over,out){
	for(var i=0;i<this.elements.length;i++){
...
Base.prototype.center=function(width,height){
	...
	for(var i=0;i<this.elements.length;i++){
		this.elements[i].style.top=top+'pxx';
		this.elements[i].style.left=left+'pxx';
	}
	return this;
}
